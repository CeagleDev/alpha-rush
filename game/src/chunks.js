...
import { signFace, noren } from './textures.js?v=202609242356';
import * as perf from './perf.js?v=202609242356';
import { bakeStatic } from '../assetlib.js?v=202609242356';
...
async function finish(ctx, B, litterCount) {
  ...
  chunk.add(baked);
  if (coarse && coarse.group) { coarse.group.visible = false; coarse.group.name = 'coarse'; chunk.add(coarse.group); chunk.userData.coarse = coarse.group; }
